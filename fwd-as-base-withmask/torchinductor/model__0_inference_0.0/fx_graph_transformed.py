class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[8, 1024, 512]", arg1_1: "f16[512, 1536]", arg2_1: "f16[1536]", arg3_1: "f32[8, 1024, 1024]", arg4_1: "f16[512, 512]", arg5_1: "f16[512]", arg6_1: "f16[512]", arg7_1: "f16[512]", arg8_1: "f16[512, 2048]", arg9_1: "f16[2048]", arg10_1: "f16[2048, 512]", arg11_1: "f16[512]", arg12_1: "f16[512]", arg13_1: "f16[512]"):
        ...
        view: "f16[8192, 512]" = torch.ops.aten.reshape.default(arg0_1, [8192, 512])
        mm: "f16[8192, 1536]" = torch.ops.aten.mm.default(view, arg1_1);  view = arg1_1 = None
        view_1: "f16[8, 1024, 1536]" = torch.ops.aten.reshape.default(mm, [8, 1024, 1536]);  mm = None
        ...
        view_2: "f16[8, 1024, 16, 32]" = torch.ops.aten.reshape.default(getitem, [8, 1024, 16, 32]);  getitem = None
        ...
        view_5: "f16[128, 1024, 32]" = torch.ops.aten.reshape.default(clone, [128, 1024, 32]);  clone = None
        
         # File: /EuroSys25/utils/utils.py:48 in transpose_for_scores, code: x = x.view(new_x_shape)
        view_3: "f16[8, 1024, 16, 32]" = torch.ops.aten.reshape.default(getitem_1, [8, 1024, 16, 32]);  getitem_1 = None
        ...
        view_6: "f16[128, 32, 1024]" = torch.ops.aten.reshape.default(clone_1, [128, 32, 1024]);  clone_1 = None
        bmm: "f16[128, 1024, 1024]" = torch.ops.aten.bmm.default(view_5, view_6);  view_5 = view_6 = None
        view_7: "f16[8, 16, 1024, 1024]" = torch.ops.aten.reshape.default(bmm, [8, 16, 1024, 1024]);  bmm = None
        ...
        amax: "f32[8, 16, 1024, 1]" = torch.ops.aten.amax.default(sub_1, [-1], True)
        sub_2: "f32[8, 16, 1024, 1024]" = torch.ops.aten.sub.Tensor(sub_1, amax);  sub_1 = amax = None
        ...
        view_8: "f16[128, 1024, 1024]" = torch.ops.aten.reshape.default(expand_2, [128, 1024, 1024]);  expand_2 = None
        
         # File: /EuroSys25/utils/utils.py:48 in transpose_for_scores, code: x = x.view(new_x_shape)
        view_4: "f16[8, 1024, 16, 32]" = torch.ops.aten.reshape.default(getitem_2, [8, 1024, 16, 32]);  getitem_2 = None
        ...
        view_9: "f16[128, 1024, 32]" = torch.ops.aten.reshape.default(clone_2, [128, 1024, 32]);  clone_2 = None
        bmm_1: "f16[128, 1024, 32]" = torch.ops.aten.bmm.default(view_8, view_9);  view_8 = view_9 = None
        view_10: "f16[8, 16, 1024, 32]" = torch.ops.aten.reshape.default(bmm_1, [8, 16, 1024, 32]);  bmm_1 = None
        ...
        view_11: "f16[8, 1024, 512]" = torch.ops.aten.reshape.default(clone_3, [8, 1024, 512]);  clone_3 = None
        ...
        view_12: "f16[8192, 512]" = torch.ops.aten.reshape.default(view_11, [8192, 512]);  view_11 = None
        mm_1: "f16[8192, 512]" = torch.ops.aten.mm.default(view_12, arg4_1);  view_12 = arg4_1 = None
        view_13: "f16[8, 1024, 512]" = torch.ops.aten.reshape.default(mm_1, [8, 1024, 512]);  mm_1 = None
        ...
        view_14: "f16[8192, 512]" = torch.ops.aten.reshape.default(convert_element_type_12, [8192, 512])
        mm_2: "f16[8192, 2048]" = torch.ops.aten.mm.default(view_14, arg8_1);  view_14 = arg8_1 = None
        view_15: "f16[8, 1024, 2048]" = torch.ops.aten.reshape.default(mm_2, [8, 1024, 2048]);  mm_2 = None
        ...
        view_16: "f16[8192, 2048]" = torch.ops.aten.reshape.default(convert_element_type_16, [8192, 2048]);  convert_element_type_16 = None
        mm_3: "f16[8192, 512]" = torch.ops.aten.mm.default(view_16, arg10_1);  view_16 = arg10_1 = None
        view_17: "f16[8, 1024, 512]" = torch.ops.aten.reshape.default(mm_3, [8, 1024, 512]);  mm_3 = None
