# 2024.2.25 Sun.
# 
#  1.多种模式的mask ： 下三角, strided, fixed
#  2.模仿使用“无同步” 来解释 fused_sparse_attention
#
#  python syncfree.py 8 1 256 12 64 0
import argparse
import timeit
import torch
import numpy as np
...
def bert_example(args):
    ...
    for i in range(warmup_iters + iters):
        ...
        if(mask_id == 0):
            hidden_states1 = syncfree_attention.run_syncfree_triangle_attention(q, k, v)
        elif(mask_id == 1): 
