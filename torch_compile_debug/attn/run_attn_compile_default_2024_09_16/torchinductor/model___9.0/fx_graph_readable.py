class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[16, 16, 256, 32]", arg1_1: "f16[16, 16, 256, 32]", arg2_1: "f16[16, 16, 256, 32]"):
        ...
        view: "f16[256, 256, 32]" = torch.ops.aten.view.default(clone, [256, 256, 32]);  clone = None
        ...
        view_1: "f16[256, 32, 256]" = torch.ops.aten.view.default(clone_1, [256, 32, 256]);  clone_1 = None
        bmm: "f16[256, 256, 256]" = torch.ops.aten.bmm.default(view, view_1);  view = view_1 = None
        view_2: "f16[16, 16, 256, 256]" = torch.ops.aten.view.default(bmm, [16, 16, 256, 256]);  bmm = None
        ...
        view_3: "f16[256, 256, 256]" = torch.ops.aten.view.default(expand_2, [256, 256, 256]);  expand_2 = None
        ...
        view_4: "f16[256, 256, 32]" = torch.ops.aten.view.default(clone_2, [256, 256, 32]);  clone_2 = None
        bmm_1: "f16[256, 256, 32]" = torch.ops.aten.bmm.default(view_3, view_4);  view_3 = view_4 = None
        view_5: "f16[16, 16, 256, 32]" = torch.ops.aten.view.default(bmm_1, [16, 16, 256, 32]);  bmm_1 = None
        return (view_5,)
