...
@torch.jit.script
def fused_with_jit_gemm0_bias0(qkv_kernel_this, qkv_bias_this, hidden_states):
	...
	return input_tensor, v, q, k, v


@torch.jit.script
def fused_with_jit_QK_mask_sfmx(q, k, mask):
...
@torch.jit.script
def fused_with_jit_gemm3_bias3(output_kernel_this, output_bias_this, residual, hidden_states):
    ...
    for i in range(warmup_iters + iters):
        ...
        with torch.no_grad():
            ...
            for layer in range(layer_num):
                ...
                input_tensor, v, q, k, v = fused_with_jit_gemm0_bias0(qkv_kernel_this, qkv_bias_this, hidden_states)

                probs = fused_with_jit_QK_mask_sfmx(q, k, mask)
                ...
                hidden_states = fused_with_jit_gemm3_bias3(output_kernel_this, output_bias_this, residual, hidden_states)
