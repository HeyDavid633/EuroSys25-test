class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[16, 256, 512]", arg1_1: "f16[512, 1536]", arg2_1: "f16[1536]", arg3_1: "f16[512, 512]", arg4_1: "f16[512]", arg5_1: "f16[512]", arg6_1: "f16[512]", arg7_1: "f16[512, 2048]", arg8_1: "f16[2048]", arg9_1: "f16[2048, 512]", arg10_1: "f16[512]", arg11_1: "f16[512]", arg12_1: "f16[512]"):
        ...
        permute_default: "f16[16, 16, 256, 32]" = torch.ops.aten.permute.default(view_2, [0, 2, 1, 3]);  view_2 = None
        permute_default_1: "f16[16, 16, 256, 32]" = torch.ops.aten.permute.default(view_3, [0, 2, 1, 3]);  view_3 = None
        permute_default_2: "f16[16, 16, 256, 32]" = torch.ops.aten.permute.default(view_4, [0, 2, 1, 3]);  view_4 = None
        ...
        getitem_7: "f16[16, 16, 256, 32]" = _scaled_dot_product_flash_attention_default[0];  _scaled_dot_product_flash_attention_default = None
        
        # File: /EuroSys25/fwd-compile-print.py:35 in fwd_bert_std, code: h = torch.matmul(probs, v).permute(0, 2, 1, 3).contiguous()
        permute_4: "f16[16, 256, 16, 32]" = torch.ops.aten.permute.default(getitem_7, [0, 2, 1, 3]);  getitem_7 = None
        clone_3: "f16[16, 256, 16, 32]" = torch.ops.aten.clone.default(permute_4, memory_format = torch.contiguous_format);  permute_4 = None
        
        # File: /EuroSys25/fwd-compile-print.py:39 in fwd_bert_std, code: hidden_states = h.view(new_context_layer_shape)
