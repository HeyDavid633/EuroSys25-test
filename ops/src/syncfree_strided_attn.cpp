...
void launcher_syncfree_strided_attn(const __half* q, const __half* k, const __half* v, __half* result,
...
void syncfree_strided_attn_gpu(at::Tensor q, at::Tensor k, at::Tensor v, at::Tensor result)
{
    ...
    launcher_syncfree_strided_attn(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("forward", &syncfree_strided_attn_gpu, "launcher_syncfree_strided_attn"); 
} 