...
# kernel path: /tmp/torchinductor_root/7h/c7hzfwpzhqklrs4txgen2lwmgthfhg4ldioq4vx5tg4oz6v5hx3i.py
...
meta0 = {'GROUP_M': 8, 'EVEN_K': True, 'ALLOW_TF32': True, 'ACC_TYPE': 'tl.float32', 'B_PROLOGUE_CAST_TYPE': None, 'BLOCK_M': 64, 'BLOCK_N': 64, 'BLOCK_K': 64}


# kernel path: /tmp/torchinductor_root/fr/cfrd7z6imtfhjw6mem6s2hhrajlaxzci3m5l4qxiuysjcjqzolvd.py
...
# kernel path: /tmp/torchinductor_root/jp/cjp6a5n2ptvit43nw4cilvzx53dw7xnoqfkkqjovcebc7p22w4vq.py
# Source Nodes: [], Original ATen: []
...
# kernel path: /tmp/torchinductor_root/5h/c5ho26dyyaz32kejcq2efwxct43e46s3pi7rx3sidsdryb5rgkce.py
# Source Nodes: [], Original ATen: []
...
# kernel path: /tmp/torchinductor_root/us/cusmewsaaeu3k52jdxgxv2he7dnsqhhfqi5joi7elmievcaqiipn.py
...
# kernel path: /tmp/torchinductor_root/z2/cz27nbwkxsfqvj2tnvzntmd5pha24hzupwwizfqcwc764si4yqhm.py
