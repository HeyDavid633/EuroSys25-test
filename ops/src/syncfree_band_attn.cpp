...
void syncfree_band_attn_gpu(at::Tensor q, at::Tensor k, at::Tensor v, at::Tensor result)
{
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("forward", &syncfree_band_attn_gpu, "launcher_syncfree_band_attn"); 
} 